...
* daily checklist runtime ปัจจุบันยังเป็น singular flow และรองรับ active template เพียง 1 อันทั้งระบบในแต่ละครั้ง  
* `Checklist Scope` เป็น metadata สำหรับจัดหมวด template และ reporting ยังไม่ใช่ trigger สำหรับหลาย execution flows คู่ขนาน
